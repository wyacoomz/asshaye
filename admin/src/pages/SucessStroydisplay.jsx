...
// //     try {
// //       const response = await axios.get('https://backend.aashayeinjudiciary.com/success/display');
...
// //             ? story.images.map(img => img.startsWith('http') ? img : `https://backend.aashayeinjudiciary.com/${img}`)
...
// //     try {
// //       await axios.delete(`https://backend.aashayeinjudiciary.com/success/${id}`);
...
// //             ? response.data.images.map(img => img.startsWith('http') ? img : `https://backend.aashayeinjudiciary.com/${img}`)
// //             : [`https://backend.aashayeinjudiciary.com/${response.data.images}`]
// //           : []
// //       };
        ...
        images: story.images
          ? Array.isArray(story.images)
            ? story.images.map((img) =>
                img.startsWith("http") ? img : `https://backend.aashayeinjudiciary.com/${img}`
              )
            : [`https://backend.aashayeinjudiciary.com/${story.images}`]
          : [],
      }));
