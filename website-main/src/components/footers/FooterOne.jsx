        ...
        <div className='td_footer_row'>
          ...
          <div className='td_footer_col'>
            <div className='td_footer_widget'>
              ...
              <ul className='td_footer_widget_menu '>
                <a className='dropdown-item mb-2' onClick={() => handleLinkClick("/")}>Home</a>
                <a className='dropdown-item mb-2' onClick={() => handleLinkClick("/about")}>About</a>
                {/* <a className='dropdown-item mb-2' onClick={() => handleLinkClick("/courses-grid-view")}>Courses</a> */}
                <a className='dropdown-item mb-2' onClick={() => handleLinkClick("/blog")}>Blogs</a>
                <a className='dropdown-item mb-2' onClick={() => handleLinkClick("/judgements")}>Judgement</a>      
                <a className='dropdown-item mb-2' onClick={() => handleLinkClick("/contact")}>Contact</a>
                <a className='dropdown-item mb-2' onClick={() => handleLinkClick("/refund")}>Refund</a>
                <a className='dropdown-item mb-2' onClick={() => handleLinkClick("/help")}>Help Center</a>
                <a className='dropdown-item mb-2' onClick={() => handleLinkClick("/privacy")}>Privacy Policy</a>
              </ul>
            </div>
          </div>
            ...
            <div className='td_footer_widget'>
              ...
              <li className='menu-item-has-children'>
                <ul className='custom-dropdown'>
                    ...
                    <li key={category._id}>
                      <a
                        ...
                        onClick={(e) => {
                          ...
                          scrollToTop();
                          navigate(
                            `/new-course?id=${category._id}&name=${encodeURIComponent(
                              category.name
                            )}`
                          );
                        }}
                 ...
                 <a className='dropdown-item' onClick={() => handleLinkClick("/otherCourse")}>Other course</a>
                </ul>
              </li>
            </div>
          </div>
