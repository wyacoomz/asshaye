...
!(function (t) {
        ...
        return (
          t
            ? this.length || "instance" !== i
              ...
              : (n = void 0)
            : (s.length && (i = f.widget.extend.apply(null, [i].concat(s))),
              this.each(function () {
                var t = f.data(this, o);
                t
    ...
    (f.Widget.prototype = {
      ...
      _createWidget: function (t, e) {
        (e = f(e || this.defaultElement || this)[0]),
          ...
          e !== this &&
            ...
            (this.document = f(e.style ? e.ownerDocument : e.document || e)),
            (this.window = f(
      ...
      option: function (t, e) {
        ...
        if ("string" == typeof t)
          if (((a = {}), (t = (i = t.split(".")).shift()), i.length)) {
            for (
              s = a[t] = f.widget.extend({}, this.options[t]), n = 0;
              n < i.length - 1;
              n++
            )
              (s[i[n]] = s[i[n]] || {}), (s = s[i[n]]);
      ...
      _on: function (n, a, t) {
        ...
        "boolean" != typeof n && ((t = a), (a = n), (n = !1)),
          t
            ? ((a = o = f(a)), (this.bindings = this.bindings.add(a)))
    ...
    _mouseInit: function () {
      ...
      this.element
        ...
        .on("click." + this.widgetName, function (t) {
          if (!0 === f.data(t.target, e.widgetName + ".preventClickEvent"))
            return (
              f.removeData(t.target, e.widgetName + ".preventClickEvent"),
        ...
        return i && !s && this._mouseCapture(t)
          ? ((this.mouseDelayMet = !this.options.delay),
            ...
            !this._mouseStarted)
              ? (t.preventDefault(), !0)
              : (!0 ===
                  f.data(t.target, this.widgetName + ".preventClickEvent") &&
                  f.removeData(
                    t.target,
      ...
      this.document
        ...
        this._mouseStarted &&
          ...
          t.target === this._mouseDownEvent.target &&
            f.data(t.target, this.widgetName + ".preventClickEvent", !0),
          this._mouseStop(t)),
          ...
          ? (!0 === t.range &&
              (t.values
                ? t.values.length && 2 !== t.values.length
                  ...
                  : f.isArray(t.values) && (t.values = t.values.slice(0))
      ...
      _mouseCapture: function (t) {
        ...
        return (
          ...
          !1 !== this._start(t, a) &&
            ...
            n.trigger("focus"),
            (e = n.offset()),
            (o = !f(t.target).parents().addBack().is(".ui-slider-handle")),
            (this._clickOffset = o
              ? { left: 0, top: 0 }
              : {
          ...
          ("range" === t &&
            ...
            ("min" === e
              ...
              : "max" === e &&
                ...
                (this.options.values = null))),
          f.isArray(this.options.values) && (s = this.options.values.length),
          this._super(t, e),
          t)
        ) {
          case "orientation":
          ...
          ? this.handles.each(function (t) {
              (i =
                ...
                (u["horizontal" === r.orientation ? "left" : "bottom"] =
                  i + "%"),
                f(this).stop(1, 1)[l ? "animate" : "css"](u, o.animate),
                !0 === r.options.range &&
      ...
      _handleEvents: {
          ...
          switch (t.keyCode) {
            ...
            case f.ui.keyCode.LEFT:
              if (
                ...
                !this._keySliding &&
                  ((this._keySliding = !0),
                  this._addClass(f(t.target), null, "ui-state-active"),
                  !1 === this._start(t, n)))
              )
                return;
          }
        ...
        keyup: function (t) {
          ...
          this._keySliding &&
            ...
            this._stop(t, e),
            this._change(t, e),
            this._removeClass(f(t.target), null, "ui-state-active"));
        },
      },
    });
  var h,
  ...
  function V(t, e, i, s) {
    return (
      ...
      ("number" != typeof e && !f.fx.speeds[e]) || ((s = i), (i = e), (e = {})),
                ...
                n instanceof p
                  ...
                  : function (t, i) {
                      ...
                      v(i.props, function (t, e) {
                        ...
                        a[s] &&
                          h.inArray(null, a[s].slice(0, 3)) < 0 &&
        ...
        v(a, function (o, r) {
          p.fn[o] ||
            (p.fn[o] = function (t) {
              ...
              return "undefined" === i
                ? a
                : ("function" === i && ((t = t.call(this, a)), (i = h.type(t))),
                  null == t && r.empty
                    ? this
                    : ("string" === i &&
                        (e = d.exec(t)) &&
        ...
        (h.cssHooks[a] = {
          ...
          (h.fx.step[a] = function (t) {
            t.colorInit ||
              ...
              (t.end = p(t.end)),
              (t.colorInit = !0)),
              h.cssHooks[a].set(t.elem, t.start.transition(t.end, t.pos));
          });
      });
    }),
    p.hook(
              ...
              (this.diff = (function (t, e) {
                ...
                for (i in e)
                  (s = e[i]),
                    t[i] !== s &&
                      (x[i] ||
                        (!f.fx.step[i] && isNaN(parseFloat(s))) ||
                        (n[i] = s));
                return n;
              })(this.start, this.end)),
              this
      ...
      removeClass:
        ...
        function (t, e, i, s) {
          return 1 < arguments.length
            ? f.effects.animateClass.call(this, { remove: t }, e, i, s)
      ...
      toggleClass:
        ...
        function (t, e, i, s, n) {
          return "boolean" == typeof e || void 0 === e
            ...
            : f.effects.animateClass.call(this, { toggle: t }, e, i, s);
        }),
    ...
    !1 !== f.uiBackCompat &&
      f.extend(f.effects, {
        ...
        createWrapper: function (i) {
          ...
          return (
            i.wrap(t),
            (i[0] !== n && !f.contains(i[0], n)) || f(n).trigger("focus"),
            (t = i.parent()),
        ...
        removeWrapper: function (t) {
          ...
          return (
            t.parent().is(".ui-effects-wrapper") &&
              ...
              (t[0] !== e && !f.contains(t[0], e)) || f(e).trigger("focus")),
            t
          );
        },
      }),
  ...
  f.effects,
    f.effects.define("slide", "show", function (t, e) {
      ...
      f.effects.createPlaceholder(n),
        ...
        "show" === o &&
          (n.cssClip(c.clip), n.css(l, c[l]), (c.clip = i), (c[l] = s)),
        n.animate(c, {
          queue: !1,
          duration: t.duration,
          easing: t.easing,
